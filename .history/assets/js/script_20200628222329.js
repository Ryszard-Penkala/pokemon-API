class pokemonAPICatalog {
    ...
    init(){
        ...
        this.search.addEventListener("keyup", searchCards());
    }
    ...
    searchCards(){
        ...
        const filteredCard = document.querySelectorAll(this.UiSelectors.card).forEach((el)=>{el.toLowerCase().contains(searchValue)})
